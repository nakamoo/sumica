...
def standard_controllers(user_name):
    return [YoutubePlayer(user_name), IRKit(user_name), PrintTest(user_name), Pose2(), Detection(), Chatbot(user_name), Snapshot(user_name), ActivityTest5(user_name), Settings(user_name)]
